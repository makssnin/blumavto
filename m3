...
|_|  |_/_/   \_\_|\_\|_| |_|_|_|
                                                                        ...
                                                                        """)
    print(Fore.RED + "https://github.com/makssnin")
...
def click_play_button(is_first_time):
    try:
        if is_first_time:
            play_button_coords = (telegram_window.left + int(telegram_window.width * 0.75),
                                  telegram_window.top + int(telegram_window.height * 0.6))
        else:
            play_button_coords = (telegram_window.left + int(telegram_window.width * 0.5),
                                  telegram_window.top + int(telegram_window.height * 0.85) - 10)  # Сместили вверх
...
def find_and_click_bacteria():
    scrn = pyautogui.screenshot(
        region=(telegram_window.left, telegram_window.top, telegram_window.width, telegram_window.height))
...
def start_game():
    ...
    while games_played < num_games:
        ...
        game_duration = 60  # Продолжительность одной игры в секундах
